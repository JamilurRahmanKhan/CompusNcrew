...
const GLASS =
  "border-beam relative overflow-hidden rounded-[1.5rem] border border-amber-200/15 bg-[#241708]/40 px-5 py-6 backdrop-blur-md sm:rounded-[1.6rem] sm:px-6 sm:py-6 md:rounded-[1.65rem] md:px-7 md:py-7 lg:rounded-[1.75rem] lg:px-11 lg:py-11 shadow-[inset_0_1px_0_rgba(255,224,178,0.3),inset_0_-2px_0_rgba(0,0,0,0.5),0_30px_80px_-24px_rgba(154,90,10,0.55)]";

const CTA = {
  from: "#ffc873",
  to: "#f0932b",
  text: "#2b1a02",
  glow: "rgba(240,147,43,0.65)",
};

export function SoftwareDevelopmentGlassCard({
  entered,
}: {
  entered: boolean;
}) {
  ...
  return (
    <div className={GLASS}>
      {/* SERVICE LABEL */}
      <div className="flex items-center gap-2">
        <span className="h-[3px] w-[3px] shrink-0 rounded-full bg-accent" />
