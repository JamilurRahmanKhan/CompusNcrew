...
// // Fully standalone glass card for "graphic-design" — edit freely, no other service
...
// const CTA = { from: "#ffdd8a", to: "#d97706", text: "#2b1a02", glow: "rgba(217,119,6,0.7)" };

// export function GraphicDesignGlassCard({ entered }: { entered: boolean }) {
...
//         <p className="text-[0.6875rem] font-semibold uppercase tracking-[0.22em] text-amber-400">
//           {service.name}
//         </p>
//       </div>

//       <h2 className="mt-4 font-display text-[2.25rem] leading-[1.04] tracking-[-0.02em] text-amber-50 sm:text-[2.65rem]">
//         {service.headline}
//       </h2>
...
export function GraphicDesignGlassCard({
  entered,
}: {
  entered: boolean;
}) {
  ...
  return (
    <div
      className="
        ...
        shadow-[
          inset_0_1px_0_rgba(255,224,178,0.3),
          inset_0_-2px_0_rgba(0,0,0,0.5),
          0_30px_80px_-24px_rgba(154,90,10,0.55)
        ]
