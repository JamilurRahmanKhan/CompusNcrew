...
// // Fully standalone glass card for "email-sms" — edit freely, no other service
...
// export function EmailSmsGlassCard({ entered }: { entered: boolean }) {
//   const service = getService("email-sms");
...
//       <p className="mt-4 max-w-[36ch] text-[0.9375rem] leading-relaxed text-violet-100/55">
//         {service.teaser}
//       </p>
...
const CTA = {
  ...
  to: "#7c4fe0",
  text: "#1a1533",
  glow: "rgba(124,79,224,0.6)",
};

export function EmailSmsGlassCard({
  entered,
}: {
  entered: boolean;
}) {
  ...
  return (
    <div
      className="
        ...
        shadow-[
          inset_0_1px_0_rgba(216,204,255,0.3),
          inset_0_-2px_0_rgba(0,0,0,0.5),
          0_30px_80px_-24px_rgba(76,29,149,0.55)
        ]
